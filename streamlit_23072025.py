        ...
        if choix_colonnes == "Toutes les colonnes":
            ...
            <table style="width: 100%; border-collapse: collapse; margin: 20px auto;">
                ...
                <tbody>
                    ...
                    <tr><td style="border: 1px solid black; padding: 8px; text-align: center;">BoroughName*</td><td style="border: 1px solid black; padding: 8px; text-align: center;">Nom de l'arrondissement</td><td style="border: 1px solid black; padding: 8px; text-align: center;">Catégorielle - sup. à 10 catégories</td></tr>
